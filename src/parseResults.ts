import { LineEval, PositionEval } from './engineTypes';

/**
 * Parses raw UCI engine output into a structured evaluation result.
 *
 * @param fen The FEN string for the evaluated position.
 * @param results The raw engine messages returned during the search.
 * @param whiteToPlay Whether White is to play in the evaluated position.
 * @returns A structured PositionEval object suitable for UI or API consumption.
 */
